...
Pour répondre à cette question, nous allons répondre progressivement aux suivantes :

1. Pourquoi un `int` fait-il 4 octets ?
2. Pourquoi un `long` fait-il 8 octets ?
3. Pourquoi un `bool` ne prend-il pas simplement 1 bit ?
4. Pourquoi tous les types n'occupent-ils pas le même espace mémoire ?
...
le nombre **18** est rangé à une adresse mémoire et que cette adresse porte le nom **age**.
...
> **À retenir :**
>
> Un `int` occupe toujours **4 octets (32 bits)**, quelle que soit la valeur qu'il contient.
>
> Que la variable contienne `18`, `1500` ou `2 000 000`, elle occupera toujours **4 octets**.

---

## Dans le prochain chapitre...

Maintenant que nous savons pourquoi un `int` occupe toujours 4 octets, nous allons répondre à une nouvelle question :
